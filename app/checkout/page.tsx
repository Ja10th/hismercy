                ...
                {cartItems.length === 0 ? (
                  ...
                  cartItems.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="flex items-center gap-4 rounded-[22px] border border-white/5 bg-white/10 p-3 backdrop-blur"
                      >
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-2">
                    <label className="space-y-2 sm:col-span-2">
                      ...
                      <input
                        ...
                        className="h-12 w-full rounded-2xl border border-neutral-100 bg-white px-4 text-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-950"
                      />
                    </label>
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="space-y-2 sm:col-span-2">
                      ...
                      <textarea
                        ...
                        className="min-h-[110px] w-full rounded-2xl border border-neutral-100 bg-white px-4 py-3 text-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-950"
                      />
                    </label>
                  </div>
                </section>
